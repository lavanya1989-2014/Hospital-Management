...
public class DoctorRestCtl {
	...
	@PostMapping("/doctor")
	public UserDTO add(@RequestBody DoctorForm form) {
		UserDTO dto=null;
		try {
	...
	@PutMapping("/doctor")
	public UserDTO update(@RequestBody DoctorForm form) {
		UserDTO dto=null;
		try {
			dto=(UserDTO)form.getDto();
			service.update(dto);
	...
	public String deleteById(@PathVariable int id) {
		...
		service.delete(dto);
		return "Deleted Doctor id is - "+id;
	}
