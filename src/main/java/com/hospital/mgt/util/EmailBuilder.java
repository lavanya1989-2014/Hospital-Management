...
public class EmailBuilder {
	...
	public static String getUserRegistrationMessage(HashMap<String, String> map) {
		...
		msg.append("Registration is successful for HealthMeet");
		msg.append("<H1>Hi! Greetings from HealthMeet!</H1>");
		msg.append(
				"<P>Congratulations for registering on HM! You can now access your HM account online - anywhere, anytime and  enjoy the flexibility to check the Hospital Services.</P>");
