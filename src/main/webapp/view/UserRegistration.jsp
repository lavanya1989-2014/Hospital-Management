...
<c:url var="addUrl" value="/Login/SignUp"></c:url>
<section class="intro">
						...
						<div class="wow fadeInRight">
							...
							<div class="panel panel-skin">
								...
								<div class="panel-body">
									<sf:form action="${addUrl }" method="post"
										modelAttribute="form" cssClass="form-horizontal">
										<sf:hidden path="id" />
											...
											<s:bind path="userName">
												<div class="col-xs-6 col-sm-6 col-md-6">
													<div class="form-group">
														...
														<div>
															<font color="red"><sf:errors path="userName" /></font>
														</div>
													</div>
												</div>
											</s:bind>
